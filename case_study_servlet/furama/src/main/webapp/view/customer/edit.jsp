...
<div class="container">
    ...
    <p>
        <button> <a href="/customer">Back to Customer list</a></button>
    </p>
    <form method="post">
        <fieldset>
            ...
            <table>
                <tr>
                    <td>Name Customer </td>
                    <td><input type="text" name="name" value="${customer.customerName}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Brithday </td>
                    <td><input type="date" name="birthday" value="${customer.customerBirthday}"></td>
                </tr>
                <tr>
                    <td>Gender </td>
                    <td>
                        <select name="gender" value="${customer.customerGender}">
                ...
                <tr>
                    ...
                    <td><input type="text" name="idCard" value="${customer.customerIdCard}" ></td>
                </tr>
                <tr>
                    <td>Customer Phone </td>
                    <td><input type="text" name="phone" value="${customer.customerPhone}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="address" value="${customer.customerAddress}" ></td>
                </tr>
                <tr>
                    <td></td>
