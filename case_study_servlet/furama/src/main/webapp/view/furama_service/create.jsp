...
<div class="container">
    ...
    <p>
        <button> <a href="/service">Back to Service list</a></button>
    </p>
    <form method="post">
        <fieldset>
                        ...
                        <label>
                            <select name="rent" >
                                <c:forEach items="${type}" var="x">
                                    <option value="${x.rentTypeId}">${x.rentTypeName}</option>
                                </c:forEach>
                            </select>
                    ...
                    <td>
                        <label>
                            <select name="service_type" >
                                <c:forEach items="${service_type}" var="y">
                                    <option value="${y.serviceTypeId}">${y.serviceTypeName}</option>
                                </c:forEach>
                            </select>
                        </label><span style="color: red">*</span>
                    </td>
