...
<div class="container">
    ...
    <p>
        <button type="button" onclick="location.href='/service?action=create';" class="csw-btn-button">Create new
            Furama Service
        </button>
    </p>
    <div class="container">
        <table class="table table-striped" id="table">
            ...
            <tr>
                ...
                <td scope="col">Max People</td>
                <td scope="col">Rent Type</td>
                <td scope="col">Service Type</td>
                <td scope="col">Standard Room</td>
                <td scope="col">Description</td>
                <td scope="col">Pool Area</td>
                <td scope="col">Number Of Floors</td>
            </tr>
            </thead>
            <tbody>
            <c:forEach items='${service}' var="x">
                <tr>
                    <td scope="col">${x.serviceId}</td>
                    <td scope="col">${x.serviceName}</td>
                    <td scope="col">${x.serviceArea}</td>
                    <td scope="col">${x.serviceCost}</td>
                    <td scope="col">${x.serviceMaxPeople}</td>
                    <td scope="col">
                        <c:forEach var="y" items="${type}">
                            <c:if test="${x.rentType eq y.rentTypeId}"
                            >${y.rentTypeName}</c:if>
                        </c:forEach>
                    </td>
                    <td scope="col">
                        <c:forEach var="z" items="${service_type}">
                            <c:if test="${x.serviceType eq z.serviceTypeId}"
                            >${z.serviceTypeName}</c:if>
                        </c:forEach>
                    </td>
                    <td scope="col">${x.standardRoom}</td>
                    <td scope="col">${x.description}</td>
                    <td scope="col">${x.poolArea}</td>
                    <td scope="col">${x.numberOfFloors}</td>
                </tr>
