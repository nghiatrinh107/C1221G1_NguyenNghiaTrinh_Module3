...
<div class="container">
    ...
    <p>
        <button> <a href="/employee">Back to Employee list</a></button>
    </p>
    <form method="post">
        <fieldset>
            ...
            <table>
                <tr>
                    <td>Employee Name </td>
                    <td><label>
                        <input type="text" name="name" value="${employee.employeeName}" >
                ...
                <tr>
                    <td>Brithday </td>
                    <td><label>
                        <input type="date" name="birthday" value="${employee.employeeBirthday}">
                    </label><span style="color: red">*</span></td>
                ...
                <tr>
                    ...
                    <td><label>
                        <input type="text" name="idCard" value="${employee.employeeIdCard}">
                    </label><span style="color: red">*</span></td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="position" >
                            <c:forEach items="${position}" var="x">
                ...
                <tr>
                    ...
                    <td>
                        <select name="degree" >
                            <c:forEach items="${degree}" var="x">
                                <option value="${x.educationDegreeId}">${x.educationDegreeName}</option>
                            </c:forEach>
                        </select><span style="color: red">*</span>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="division" >
                            <c:forEach items="${division}" var="x">
                                <option value="${x.divisionId}">${x.divisionName}</option>
                            </c:forEach>
                        </select><span style="color: red">*</span>
                    </td>
