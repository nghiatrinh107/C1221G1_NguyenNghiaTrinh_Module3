...
<div class="class= container-fluid ">
    ...
    <p>
        <button type="button" onclick="location.href='/employee?action=create';" class="csw-btn-button">Create new
            Employee
        </button>
    </p>
    <div class=" container-fluid">
        <table class="table table-striped m-4 table-bordered" id="tableCustomer" >
            <thead>
            <tr>
                <td scope="col-">STT</td>
                ...
                <td scope="col-">Education Degree</td>
            ...
            <tbody>
            <c:forEach items='${employee}' var="x" varStatus="stt">
                <tr>
                    <td scope="col-">${stt.count}</td>
                    <td scope="col-">${x.employeeName}</td>
                    <td scope="col-">${x.employeeBirthday}</td>
                    <td scope="col-">${x.employeeIdCard}</td>
                    <td scope="col-">${x.salary}</td>
                    <td scope="col-">${x.phone}</td>
                    <td scope="col-">${x.email}</td>
                    <td scope="col-">${x.address}</td>
                    <td scope="col">
                        <c:forEach var="y" items="${position}">
                            <c:if test="${x.position eq y.positionId}"
                            >${y.positionName}</c:if>
                        </c:forEach>
                    </td>
                    <td scope="col">
                        <c:forEach var="y" items="${degree}">
                            <c:if test="${x.educationDegree eq y.educationDegreeId}"
                            >${y.educationDegreeName}</c:if>
                        </c:forEach>
                    </td>
                    <td scope="col">
                        <c:forEach var="y" items="${division}">
                            <c:if test="${x.division eq y.divisionId}"
                            >${y.divisionName}</c:if>
                        </c:forEach>
                    </td>
                    <td scope="col-">
                        <button type="button" class="btn btn-secondary"><a
                                href="/employee?action=edit&id=${x.getEmployeeId()}">edit</a></button>
                    </td>
                    <td scope="col">
                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                data-target="#exampleModalCenter"
                                onclick="deleteId(${x.getEmployeeId()})">
                            delete
                        </button>
                        <!-- Modal -->
